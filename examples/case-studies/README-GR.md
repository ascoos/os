...
| AI / Macros | [Συνθετική Ανάλυση Μακροεντολών](./ai/semantic_macro_profiler/semantic_macro_profiler-GR.md) | Αναλύει περιεχόμενο με NLP, προβλέπει εκτέλεση μακροεντολών με AI, και τις ενεργοποιεί βάσει DSL. | [`ai/semantic_macro_profiler`](./ai/semantic_macro_profiler/) |
...
| Ασφάλεια / Επικεφαλίδες | [Προηγμένη Διαχείριση Headers Ασφαλείας με Αυθεντικοποίηση](./security/headers/security_header_authentication_management/security_header_authentication_management-GR.md) | Επιδεικνύει τη ρύθμιση headers, την επικύρωση SSL/TLS, τη διαχείριση γεγονότων και την καταγραφή. | [`security/headers/security_header_authentication_management`](./security/headers/security_header_authentication_management/) |
| Αυθεντικοποίηση | [Επικύρωση και Αυθεντικοποίηση Χρήστη με Καταγραφή Γεγονότων](./auth/validated_login_flow/validated_login_flow-GR.md) | Επικυρώνει τα credentials ενός χρήστη πριν την αυθεντικοποίηση, καταγράφοντας τα αντίστοιχα γεγονότα. | [`auth/validated_login_flow`](./auth/validated_login_flow/) |
...
| Ενσωμάτωση / Laravel | [Ενσωμάτωση Laravel στο Ascoos OS](./integration/laravel/autoload/laravel_autoload-GR.md) | Επιδεικνύει τη φόρτωση του Laravel, την αρχικοποίηση με macros και events, και τη σύνδεση με το global scope. | [`integration/laravel/autoload`](./integration/laravel/autoload/) |
| Επιστήμη / Φυσική | [Προσομοίωση Τροχιάς Δορυφόρου](./science/physics/orbital_simulation/orbital_simulation-GR.md) | Προσομοιώνει έναν δορυφόρο σε κυκλική τροχιά γύρω από τη Γη. | [`science/physics/orbital_simulation`](./science/physics/orbital_simulation/) |
...
| Ιστοσελίδες / Apache | [Παρακολούθηση Ιστοσελίδων με Γλωσσική Ανάλυση και Βελτιστοποίηση Apache](./websites/apache_optimization/website_monitoring_with_apache_optimization-GR.md) | Παρακολουθεί ιστοσελίδες και βελτιστοποιεί τη διαμόρφωση του Apache με βάση τα αποτελέσματα της ανάλυσης. | [`apache/apache_optimization`](./websites/apache_optimization/) |
