...
| Σύστημα / Υψηλής Απόδοσης | [Ισορροπιστής Φόρτου με Νήματα](./system/performance/) | Κατανέμει εργασίες σε νήματα με βάση τον φόρτο CPU και RAM, παρακάμπτοντας νήματα όταν οι πόροι είναι υπερφορτωμένοι. | [`system/performance`](./system/performance/) |
| Automation / DevOps | [Μηχανή Εργασιών με Μακροεντολές](./automation/macros/) | Εκτελεί αλυσίδες ενεργειών με λογική FIFO, καθυστέρηση, προτεραιότητα και καταγραφή. | [`automation/macros`](./automation/macros/) |
