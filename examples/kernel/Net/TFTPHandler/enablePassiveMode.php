 ...
 * 
 * @desc <English> Demonstrates enabling FTP passive mode using the enablePassiveMode method.
 * @desc <Greek> Παρουσιάζει την ενεργοποίηση της λειτουργίας passive του FTP χρησιμοποιώντας τη μέθοδο enablePassiveMode.
 * 
 * @since PHP 8.2.0
 */
...
$ftpHandler->connect('example.com', 21, 'user', 'pass', false);

// <English> Enable passive mode
// <Greek> Ενεργοποίηση λειτουργίας passive
if ($ftpHandler->enablePassiveMode(true)) {
    echo "Passive mode enabled successfully\n";
} else {
