 ...
 * 
 * @desc <English> Demonstrates retrieving the current directory using the getCurrentDirectory method.
 * @desc <Greek> Παρουσιάζει την ανάκτηση του τρέχοντος καταλόγου χρησιμοποιώντας τη μέθοδο getCurrentDirectory.
 * 
 * @since PHP 8.2.0
 */
...
// <English> Retrieve current directory
// <Greek> Ανάκτηση τρέχοντος καταλόγου
$currentDir = $ftpHandler->getCurrentDirectory();
