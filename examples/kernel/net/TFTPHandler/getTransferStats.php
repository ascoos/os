 ...
 * 
 * @desc <English> Demonstrates retrieving transfer statistics using the getTransferStats method.
 * @desc <Greek> Παρουσιάζει την ανάκτηση στατιστικών μεταφοράς χρησιμοποιώντας τη μέθοδο getTransferStats.
 * 
 * @since PHP 8.2.0
 */
...
// <English> Perform a file transfer to generate stats
// <Greek> Εκτέλεση μεταφοράς αρχείου για δημιουργία στατιστικών
$ftpHandler->downloadFile('/remote/path/file.txt', $AOS_TMP_PATH . '/downloaded_file.txt', FTP_BINARY);

// <English> Retrieve transfer statistics
// <Greek> Ανάκτηση στατιστικών μεταφοράς
$stats = $ftpHandler->getTransferStats();
print_r($stats);
