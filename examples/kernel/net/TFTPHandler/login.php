 ...
 * 
 * @desc <English> Demonstrates logging into an FTP/SFTP server using the login method.
 * @desc <Greek> Παρουσιάζει τη σύνδεση σε διακομιστή FTP/SFTP χρησιμοποιώντας τη μέθοδο login.
 * 
 * @since PHP 8.2.0
 */
...
// <English> Login to the server
// <Greek> Σύνδεση στον διακομιστή
if ($ftpHandler->login('user', 'pass')) {
