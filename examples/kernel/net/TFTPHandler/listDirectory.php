 ...
 * 
 * @desc <English> Demonstrates listing directory contents using the listDirectory method.
 * @desc <Greek> Παρουσιάζει τη λίστα περιεχομένων καταλόγου χρησιμοποιώντας τη μέθοδο listDirectory.
 * 
 * @since PHP 8.2.0
 */
...
// <English> List directory contents
// <Greek> Λίστα περιεχομένων καταλόγου
$files = $ftpHandler->listDirectory('/remote/path');
print_r($files);
