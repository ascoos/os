 ...
 * 
 * @desc <English> Demonstrates reconnecting to the server using the reconnect method.
 * @desc <Greek> Παρουσιάζει την επανασύνδεση στον διακομιστή χρησιμοποιώντας τη μέθοδο reconnect.
 * 
 * @since PHP 8.2.0
 */
...
// <English> Disconnect and reconnect
// <Greek> Αποσύνδεση και επανασύνδεση
$ftpHandler->disconnect();
if ($ftpHandler->reconnect()) {
