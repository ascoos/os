...
## Our Philosophy
> *The future lies in the simplicity of complexity.*

Ascoos OS is built on this principle. It doesn't try to be easy internally. However, it tries to be **clean, precise, extensible, and deep** to facilitate its use.
